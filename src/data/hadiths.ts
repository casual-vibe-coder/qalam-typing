...
export interface HadithEntry {
  ...
  narrator: string;
  reference: string;
  collection: "selected" | "nawawi40";
}

export interface HadithCollection {
  id: HadithEntry["collection"];
  name: string;
  description: string;
}

export const HADITH_COLLECTIONS: HadithCollection[] = [
  { id: "selected", name: "Selected Hadith", description: "A handful of well-known, short hadith to start with." },
  {
    id: "nawawi40",
    name: "An-Nawawi's 40 Hadith",
    description:
      "The full traditional text of each hadith — isnad and closing attribution included, since that's how this famous collection is conventionally memorized, not trimmed to bare matn like the Selected set above.",
  },
];

// The 42-hadith Arabic text below (an-Nawawi's collection traditionally
// runs to 42, not a literal 40) is pulled verbatim from the fawazahmed0/
// hadith-api "ara-nawawi" edition (English from "eng-nawawi", same source),
// full isnad and attribution intact — see HADITH_COLLECTIONS above for why
// that's kept here unlike the trimmed "selected" set.
export const HADITHS: HadithEntry[] = [
  ...
  },
  {
    ...
    narrator: "Abu Hafs 'Umar bin al-Khattab",
    reference: "An-Nawawi's 40 Hadith, No. 1",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "`Umar",
    reference: "An-Nawawi's 40 Hadith, No. 2",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Hadith 3 narrator",
    reference: "An-Nawawi's 40 Hadith, No. 3",
    collection: "nawawi40",
  },
  {
    ...
    reference: "An-Nawawi's 40 Hadith, No. 4",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Aisha",
    reference: "An-Nawawi's 40 Hadith, No. 5",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "an-Nu’man ibn Basheer",
    reference: "An-Nawawi's 40 Hadith, No. 6",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Tameem ibn Aus ad-Daree",
    reference: "An-Nawawi's 40 Hadith, No. 7",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abdullah ibn Umar",
    reference: "An-Nawawi's 40 Hadith, No. 8",
    collection: "nawawi40",
  },
  {
    ...
    reference: "An-Nawawi's 40 Hadith, No. 9",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 10",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Hadith 11 narrator",
    reference: "An-Nawawi's 40 Hadith, No. 11",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 12",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hamzah Anas bin Malik",
    reference: "An-Nawawi's 40 Hadith, No. 13",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Ibn Masood",
    reference: "An-Nawawi's 40 Hadith, No. 14",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 15",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 16",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Ya’la Shaddad bin Aws",
    reference: "An-Nawawi's 40 Hadith, No. 17",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Hadith 18 narrator",
    reference: "An-Nawawi's 40 Hadith, No. 18",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Abbas Abdullah bin Abbas",
    reference: "An-Nawawi's 40 Hadith, No. 19",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Masood Uqbah bin ’Amr al-Ansaree al-Badree",
    reference: "An-Nawawi's 40 Hadith, No. 20",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu `Amr",
    reference: "An-Nawawi's 40 Hadith, No. 21",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Abdullah Jabir bin Abdullah al-Ansaree",
    reference: "An-Nawawi's 40 Hadith, No. 22",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Malik al-Harith bin Asim al-Asharee",
    reference: "An-Nawawi's 40 Hadith, No. 23",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Hadith 24 narrator",
    reference: "An-Nawawi's 40 Hadith, No. 24",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Dharr",
    reference: "An-Nawawi's 40 Hadith, No. 25",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 26",
    collection: "nawawi40",
  },
  {
    ...
    reference: "An-Nawawi's 40 Hadith, No. 27",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Najeeh al-’Irbaad ibn Saariyah",
    reference: "An-Nawawi's 40 Hadith, No. 28",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Muadh bin Jabal",
    reference: "An-Nawawi's 40 Hadith, No. 29",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Tha’labah al-Kushanee",
    reference: "An-Nawawi's 40 Hadith, No. 30",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu al-’Abbas Sahl bin Sa’ad as-Sa’idee",
    reference: "An-Nawawi's 40 Hadith, No. 31",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Sa’eed al-Khudree",
    reference: "An-Nawawi's 40 Hadith, No. 32",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Ibn Abbas",
    reference: "An-Nawawi's 40 Hadith, No. 33",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Sa`eed al-Khudree",
    reference: "An-Nawawi's 40 Hadith, No. 34",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 35",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 36",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Hadith 37 narrator",
    reference: "An-Nawawi's 40 Hadith, No. 37",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Hurayrah",
    reference: "An-Nawawi's 40 Hadith, No. 38",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Ibn Abbas",
    reference: "An-Nawawi's 40 Hadith, No. 39",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abdullah ibn Umar",
    reference: "An-Nawawi's 40 Hadith, No. 40",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Abu Muhammad Abdullah bin ’Amr bin al-’Aas",
    reference: "An-Nawawi's 40 Hadith, No. 41",
    collection: "nawawi40",
  },
  {
    ...
    narrator: "Anas",
    reference: "An-Nawawi's 40 Hadith, No. 42",
    collection: "nawawi40",
  },
];
